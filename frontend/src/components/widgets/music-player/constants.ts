...
const PLAYLIST: Omit<Song, "id">[] = [
    {
        title: "恋人",
        artist: "三理Mit3uri",
        cover: "assets/music/cover/三理Mit3uri - 恋人.webp",
        url: "assets/music/url/三理Mit3uri - 恋人.mp3",
        duration: 0,
    },
    {
        title: "NIGHT DANCER",
...
export const LOCAL_PLAYLIST: Song[] = PLAYLIST.map((song, index) => ({
    ...song,
    id: index + 1,
}));
